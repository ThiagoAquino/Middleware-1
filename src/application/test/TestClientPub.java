...
public class TestClientPub implements Iapp {

	private String userAddress;
	private int userPort;
	private ArrayList<SubscriberThread> subscriberThreads;

	public TestClientPub() throws UnknownHostException{
	...
	public static void main(String [] args) throws UnknownHostException, IOException{
		TestClientPub user = null;
		try {
			user = new TestClientPub();
		...
		while(shouldContinue && i > 0) {
			String userChoice = "publishTopic pubTest msg"+i;
	...
	private static void handleSubscribeTopic(TestClientPub user, String userChoice) {
		String topicName;
	...
	private static void handleUnsusbcribeTopic(TestClientPub user, String userChoice) {
		String topicName;
		String [] parts = userChoice.split(" ");
		topicName = parts[1];
	...
	private static void handlePublishTopic(TestClientPub user, String userChoice) throws UnknownHostException, IOException {
		String topicName;
		String content;
		String[] parts = userChoice.split(" ");
